...
class ItinerariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post itineraries_url, params: { itinerary: { description: @itinerary.description, image: @itinerary.image, name: @itinerary.name, title: @itinerary.title, trip_id: @itinerary.trip_id } }
    end
  ...
  test "should update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { description: @itinerary.description, image: @itinerary.image, name: @itinerary.name, title: @itinerary.title, trip_id: @itinerary.trip_id } }
